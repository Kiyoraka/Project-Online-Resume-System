<?php
/**
 * Online Resume System - Sidebar Component
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <a href="index.php" class="sidebar-logo">
            ...
            <span class="sidebar-logo-text">Resume Admin</span>
        </a>
    </div>
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            <div class="nav-section-title">Resume Content</div>
            ...
            <a href="experiences.php" class="nav-link <?= $currentPage === 'experiences' ? 'active' : '' ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="education.php" class="nav-link <?= $currentPage === 'education' ? 'active' : '' ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="skills.php" class="nav-link <?= $currentPage === 'skills' ? 'active' : '' ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                </svg>
                Skills
            </a>
            <a href="certifications.php" class="nav-link <?= $currentPage === 'certifications' ? 'active' : '' ?>">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
